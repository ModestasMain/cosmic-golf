...
const PLANET_TEXTURE_PATHS = [
  '/textures/ashvolcanic.webp',
  '/textures/carbon.webp',
  '/textures/crackedice.webp',
  '/textures/earth.webp',
  '/textures/ice.webp',
  '/textures/indigo.webp',
  '/textures/jupiter.webp',
  '/textures/lava.webp',
  '/textures/mercury.webp',
  '/textures/methane.webp',
  '/textures/mineral.webp',
  '/textures/ocean.webp',
  '/textures/pastel.webp',
  '/textures/pink.webp',
  '/textures/purple.webp',
  '/textures/sand.webp',
  '/textures/stormyblue.webp',
  '/textures/superstorm.webp',
  '/textures/toxic.webp',
];
